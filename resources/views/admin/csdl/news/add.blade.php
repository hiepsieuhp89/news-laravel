<div class="modal fade hidden" action="add" target='news' tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-content" style="height: 100%;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Thêm bài viết</h5>
        <button type="button" class="close" data-dismiss="modal" action="add" target='news'  aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="overflow-y: scroll;">
        <form class="" action="{{ route('admin.database.news.add') }}" method="post" enctype="multipart/form-data" entity-name="news" id="news_add_form">
        @csrf
        <div class="row">
          <div class="col-md-8">
            <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="file" accept="image/*" form_target='news_add_form' name="image" class="form-control" placeholder="Ảnh">
          ...
          <div class="col-md-12">
            <div class="form-group">
                ...
                <div id="news_addEditor" class="form-control" name="description">
                  <p>Nhập mô tả</p>
                </div>
                <div class="invalid-feedback"></div>
            </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary submit-btn" action="add" target="news" form_target="news_add_form">Thêm</button>
      </div>
    </div>
</div>